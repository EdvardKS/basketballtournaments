...
export function PlayerCard({ player, className, size = "md", onClick }: PlayerCardProps) {
  const sizeClasses = {
  ...
  // FIFA Gold Card Colors
  const cardGradient = "bg-linear-to-b from-[#e6c15c] via-[#bf953f] to-[#b38728]";
  const cardBorder = "border-[#fbf5b7]";
  
  // Or Modern Dark Sport Style
